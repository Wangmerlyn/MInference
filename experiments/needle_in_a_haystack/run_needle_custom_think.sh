...
# Default parameters
model_name=" /mnt/longcontext/models/siyuan/rl_ckpts/curnodis169_2node_16k_2k_math_FILTERedAGAIN_dis_numchain64_mathqa_512bsz_grpo_SUBEM_end-step14-Yarn"
max_length=128000
min_length=1000
rounds=5
attn_type="vllm"
needle_output_path="./think_needle"
summary_output_path="./think_needle"
figure_output_path="./think_figures"
...
run_name="${attn_type}_${model_name_last_part}_${attn_type}"
